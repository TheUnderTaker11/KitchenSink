...
public class CraftingManager{
	public static void init(){
		...
		//Recipe is actually added at the very bottom to make sure its the first to show up!
		...
		GameRegistry.addRecipe(zombieknife, " y ", "yxy", "aza", 'x', Items.IRON_SWORD, 'y', Items.ROTTEN_FLESH, 'a', Items.CARROT, 'z', Items.DIAMOND);
		GameRegistry.addRecipe(skeletonknife, " y ", "yxy", "aza", 'x', Items.IRON_SWORD, 'y', Items.BONE, 'a', Items.ARROW, 'z', Items.DIAMOND);
		GameRegistry.addRecipe(creeperknife, " y ", "yxy", "aza", 'x', Items.IRON_SWORD, 'y', Items.GUNPOWDER, 'a', Blocks.TNT, 'z', Items.DIAMOND);
		GameRegistry.addRecipe(endermanknife, " y ", "yxy", "aza", 'x', Items.IRON_SWORD, 'y', Items.ENDER_EYE, 'a', Items.ENDER_PEARL, 'z', Items.DIAMOND);
		...
		//This recipe is added down here so it is the first to show up in JEI
